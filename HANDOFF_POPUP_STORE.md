...
- 특히 아래는 매번 재확인: **브리핑 형식(§0 하단)**, **모델 추천(§24)**, **HANDOFF 실시간 갱신(§0 아래 섹션)**, **한국어 대화 규칙**, **실기 확인 방법 = §0 「한 줄씩 복붙」 형식(생략 금지)**.
...
| **Git 상태** | `main` **`78e4bb2`** + **미커밋** §58 Phase 1-A/B (`StoreShopPage` · 앱 `/shop` WebView · layout 숨김 · `VITE_WORLD_ENABLED`) |
