...
> **다음 세션 빠른 시작:** `## 7.0` **「다음 세션 착수 가이드」** → **`§7.50` 최신** → **`§7.49`** → `## 8. Changelog` 최신 항목
...
| AD-073 | **(설계 · User 2026-08-27) 반품·교환 v2 로드맵** — 지금 = **반품지·안내 + 클레임 v1** · v2 = **전용 탭·구조화 신청·입고·환불** · §7.48~§7.49 | User 2026-08-27 | 2026-08-27 |
...
| | |
|---|---|
| **한 줄 요약** | **§58 #8 P1** · AD-069/072 ✅ · **반품 v2 = AD-073/074 (설계 · §7.48~§7.49)** · PG=게이트 |
| **Git 상태** | `main` **`75205e2`** push ✅ |
...
**최신** — **AD-074~076 · §7.49~§7.50 · §62 · §53.9** (docs · push 직후 hash 갱신)

| | |
|---|---|
| **다음 우선 (에이전트)** | **§58 #8 P1** · User OK 시 **AD-073 Phase R1** |
| **반품 정책** | **AD-074 확정** — 단순변심 **점주 설정** · **교환+반품** · **가챠 반납 3상태** · §7.49 |
| **알림·반품지** | **AD-076** — 손님 **알림 탭** · 점주 **반품지 = 배송지형 CRUD + 우편 검색** · §7.50 |
| **판매자센터 확장** | User 2026-08-27 목록 → **§53.9 로드맵** (PG 전 / PG 후 구분) |
| **상세** | **§7.50** · **§7.49** · **§7.48** · 주문 수정 = **§7.45~§7.47**
...
4. R1만 먼저 할지 · R2까지 한 번에 할지 → **에이전트 권장: R1 → R2** (§7.49)
...
|---|---|
| **R1** | 변경 없음 — 탭·큐·뱃지 |
| **R2** | `order_returns` + **점주 정책 컬럼** + **return/exchange kind** + **가챠 3상태** + 손님 **정책 기반 사유 UI** |
...
| **R2** | 반품지 CRUD + **AddressSearch** + 손님 **반품지 안내** |
...
*§62 Last updated: 2026-08-27 (AD-076 · 알림 탭 · 반품지)*
