...
> **다음 세션 빠른 시작:** `## 7.0` **「다음 세션 착수 가이드」** → **`§7.52` 최신** → **`§7.51`** → `## 8. Changelog` 최신 항목
...
| AD-077 | **(확정 · User 2026-08-27) 문의 유지 + 이력·타임스탬프 + 반품 신청 병행** — **「문의하기」유지**(v1 메커니즘) · **2회차+「이전 문의 보기」** · **손님·점주 모두 문의/답변에 접수·답변 시각 필수**(민원·객관 증빙) · **「반품·교환 신청」= R2 별도 버튼**(`order_returns` · 문의와 **DB·UI 분리**) · §7.52 | User 2026-08-27 | 2026-08-27 |
...
| **다음 에이전트 1순위** | ① **AD-077 문의 v1.5** ② **AddressSearch** ③ **store_return_addresses** ④ **R2** |
...
| | |
|---|---|
| **다음 우선 (에이전트)** | ① **AD-077 문의 이력·타임스탬프** ② **AddressSearch** ③ **R2 반품·교환 신청** |
| **문의 vs 반품** | **문의하기 유지** · **반품·교환 신청 = 별도 버튼**(R2) · §7.52 |
| **반품 정책** | **AD-074 확정** — §7.49 |
| **알림·반품지** | **AD-076** — §7.50 |
| **상세** | **§7.52** · **§7.51** · **§7.48~§7.50** |
...
| **R1.5** | **문의 이력·시각** | **「문의하기」유지** · 카드=최근 1세트 · **2회차+「이전 문의 보기」** · **접수·답변 타임스탬프 필수** (손님·점주) | **AD-077** · §7.52 |
